          ...
          case 'save_report':
            ...
            if (addReport && pendingAction.data) {
              ...
              const report = {
                ...
                name: `AI ${reportType.charAt(0).toUpperCase() + reportType.slice(1)} Report`,
                type: reportType as 'administrative' | 'financial' | 'time-tracking' | 'expenses' | 'custom',
                generatedDate: new Date().toISOString(),
                projectIds: reportData.projects?.map((p: any) => p.projectId || p.id) || [],
                projectsCount: reportData.projectCount || reportData.projects?.length || 0,
              ...
              console.log('[AI Action] Report saved to database:', report.name);
            }
            break;
