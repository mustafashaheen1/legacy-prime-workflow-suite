...
function RootLayoutNav() {
  ...
  // Global notification listener — keeps the bell badge live on every screen.
  // Uses Realtime instead of polling so DB is only hit when data actually changes.
  useEffect(() => {
    ...
    const fetchUnreadCount = async () => {
      try {
        ...
        for (const p of parts) {
          ...
          myLastReadByConv[p.conversation_id] =
        ...
        for (const msg of (unreadMsgs || []) as any[]) {
          const lastRead =
            myLastReadByConv[msg.conversation_id] || "1970-01-01T00:00:00.000Z";
  ...
  return (
    ...
    >
      ...
      />
      <Stack.Screen
        name="project/[id]/takeoff"
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="project/[id]/expenses"
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="project/[id]/files-navigation"
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="project/[id]/change-orders"
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="project/[id]/costs"
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="project/[id]/labor"
        options={{ headerShown: false }}
      />
      {/* Public pages - no header */}
      <Stack.Screen
        name="inspection/[token]"
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="subcontractor-register/[token]"
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="register-subcontractor/[token]"
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="schedule-view/[token]"
        options={{ headerShown: false }}
      />
